...
/**
 * Activity for Eyes, an app that uses the camera to track faces and superimpose Googly Eyes
 ...
 */
public final class EyesTrackerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_eyes_tracker);
    ...
    private FaceDetector createFaceDetector(Context context) {
        ...
        if (mIsFrontFacing) {
            ...
            // face position.
            Tracker<Face> tracker = new EyesTracker(mOverlay, EyesTrackerActivity.this);
            ...
            MultiProcessor.Factory<Face> factory = new MultiProcessor.Factory<Face>() {
                ...
                public Tracker<Face> create(Face face) {
                    return new EyesTracker(mOverlay, EyesTrackerActivity.this);
                }
            };
